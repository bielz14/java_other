...
public class JavaSearchWay {
	...
	public static void main(String[] args) {
		...
		int one_point = 61;
		int two_point = 16;
		vyvod(one_point, two_point);//ввод индекса точек для поиска пути между ними 
		way=test2(one_point, two_point, puti1);
		System.out.println("The path between points "+two_point+" and "+one_point+" is written in the array shown below");
	 ...
	 * prohodka = 1; konec = 1; break; } // ïðîõîäêà íèæå íå ïðîèñõîäèò } // //
